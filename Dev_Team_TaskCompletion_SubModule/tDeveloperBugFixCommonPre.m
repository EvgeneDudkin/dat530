function [fire, transition] = tDeveloperBugFixCommonPre(devEntity, transition, delay)

tokenId = tokenAllColor('pTaskTested', 1, {devEntity, 'BugFixNeeded'}); % select a task that needs to be fixed
...
disp(['Developer: ',  colors{1}, ' fixed the bugs']);
